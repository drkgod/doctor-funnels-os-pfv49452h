...
//   quoted_message_id: text (nullable)
// Table: notifications
//   id: uuid (not null, default: gen_random_uuid())
//   tenant_id: uuid (not null)
//   user_id: uuid (nullable)
...
//   from_name: text (not null, default: ''::text)
//   from_email: text (not null, default: ''::text)
//   reply_to: text (nullable, default: ''::text)
//   domain: text (nullable, default: ''::text)
//   domain_verified: boolean (nullable, default: false)
//   use_custom_key: boolean (nullable, default: false)
//   created_at: timestamp with time zone (nullable, default: now())
//   updated_at: timestamp with time zone (nullable, default: now())
...
//   CHECK medical_reports_report_type_check: CHECK ((report_type = ANY (ARRAY['atestado'::text, 'laudo'::text, 'encaminhamento'::text, 'solicitacao_exames'::text])))
...
//   CHECK messages_message_type_check: CHECK ((message_type = ANY (ARRAY['text'::text, 'image'::text, 'audio'::text, 'document'::text, 'video'::text, 'sticker'::text, 'location'::text, 'contact'::text, 'link'::text, 'reaction'::text, 'poll'::text, 'other'::text])))
...
//   FOREIGN KEY notifications_tenant_id_fkey: FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
//   CHECK notifications_type_check: CHECK ((type = ANY (ARRAY['appointment'::text, 'record'::text, 'transcription'::text, 'system'::text, 'alert'::text])))
...
//   CHECK pipeline_stages_semantic_type_check: CHECK (((semantic_type IS NULL) OR (semantic_type = ANY (ARRAY['entry'::text, 'booked'::text, 'completed'::text, 'cancelled'::text]))))
...
//   CHECK prescriptions_prescription_type_check: CHECK ((prescription_type = ANY (ARRAY['simple'::text, 'special_control'::text, 'antimicrobial'::text])))
...
// Table: tenant_email_settings
//   PRIMARY KEY tenant_email_settings_pkey: PRIMARY KEY (id)
//   FOREIGN KEY tenant_email_settings_tenant_id_fkey: FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE
//   UNIQUE tenant_email_settings_tenant_id_provider_key: UNIQUE (tenant_id, provider)
// Table: tenant_email_usage
...
//   Policy "super_admin_all" (ALL, PERMISSIVE) roles={public}
//     USING: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_select_bot_embeddings" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: ((tenant_id = get_user_tenant_id()) OR (get_user_role() = 'super_admin'::text))
// Table: conversations
//   Policy "super_admin_all" (ALL, PERMISSIVE) roles={public}
//     USING: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_crud" (ALL, PERMISSIVE) roles={public}
...
//     USING: (get_user_role() = 'super_admin'::text)
//     WITH CHECK: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_delete_doc_signatures" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (tenant_id = get_user_tenant_id())
...
//     USING: (tenant_id = get_user_tenant_id())
//   Policy "tenant_update_doc_signatures" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: (tenant_id = get_user_tenant_id())
//     WITH CHECK: (tenant_id = get_user_tenant_id())
// Table: email_campaigns
//   Policy "super_admin_all" (ALL, PERMISSIVE) roles={public}
...
//     USING: (get_user_role() = 'super_admin'::text)
//     WITH CHECK: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_delete_record_sections" (DELETE, PERMISSIVE) roles={authenticated}
...
//     USING: (get_user_role() = 'super_admin'::text)
//     WITH CHECK: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_delete_medical_records" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (tenant_id = get_user_tenant_id())
...
//     USING: (get_user_role() = 'super_admin'::text)
//     WITH CHECK: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_delete_med_reports" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (tenant_id = get_user_tenant_id())
...
//     USING: (tenant_id = get_user_tenant_id())
// Table: notifications
//   Policy "sa_all_notifications" (ALL, PERMISSIVE) roles={authenticated}
//     USING: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_delete_notifications" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: ((tenant_id = get_user_tenant_id()) AND ((user_id = auth.uid()) OR (user_id IS NULL)))
//   Policy "tenant_insert_notifications" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: (tenant_id = get_user_tenant_id())
//   Policy "tenant_select_notifications" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: ((tenant_id = get_user_tenant_id()) AND ((user_id = auth.uid()) OR (user_id IS NULL)))
//   Policy "tenant_update_notifications" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: ((tenant_id = get_user_tenant_id()) AND ((user_id = auth.uid()) OR (user_id IS NULL)))
// Table: patients
//   Policy "super_admin_all" (ALL, PERMISSIVE) roles={public}
//     USING: (get_user_role() = 'super_admin'::text)
...
//     USING: (get_user_role() = 'super_admin'::text)
//     WITH CHECK: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_delete_prescriptions" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (tenant_id = get_user_tenant_id())
...
//     USING: (get_user_role() = 'super_admin'::text)
//     WITH CHECK: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_delete_specialty_templates" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (tenant_id = get_user_tenant_id())
...
//   Policy "super_admin_all" (ALL, PERMISSIVE) roles={public}
//     USING: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_insert_api_keys" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: (tenant_id = get_user_tenant_id())
//   Policy "tenant_members_select" (SELECT, PERMISSIVE) roles={public}
//     USING: (tenant_id = get_user_tenant_id())
//   Policy "tenant_update_api_keys" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: (tenant_id = get_user_tenant_id())
//     WITH CHECK: (tenant_id = get_user_tenant_id())
// Table: tenant_email_settings
//   Policy "Service role full access email settings" (ALL, PERMISSIVE) roles={service_role}
//     USING: true
//   Policy "Tenant users can insert own email settings" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: (tenant_id = ( SELECT get_user_tenant_id() AS get_user_tenant_id))
//   Policy "Tenant users can read own email settings" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (tenant_id = ( SELECT get_user_tenant_id() AS get_user_tenant_id))
//   Policy "Tenant users can update own email settings" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: (tenant_id = ( SELECT get_user_tenant_id() AS get_user_tenant_id))
// Table: tenant_email_usage
//   Policy "super_admin_all" (ALL, PERMISSIVE) roles={public}
//     USING: (get_user_role() = 'super_admin'::text)
...
//     USING: (get_user_role() = 'super_admin'::text)
//     WITH CHECK: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_delete_transcriptions" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (tenant_id = get_user_tenant_id())
...
//     USING: (get_user_role() = 'super_admin'::text)
//     WITH CHECK: (get_user_role() = 'super_admin'::text)
//   Policy "tenant_delete_treatment_plans" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (tenant_id = get_user_tenant_id())
...
//     WITH CHECK: (tenant_id = get_user_tenant_id())
// Table: verification_codes
//   Policy "authenticated_select_verification" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: ((tenant_id = get_user_tenant_id()) OR (get_user_role() = 'super_admin'::text))
...
//   CREATE INDEX idx_body_maps_record_id ON public.body_maps USING btree (record_id)
// Table: bot_configs
...
//   CREATE INDEX idx_bot_embeddings_embedding ON public.bot_embeddings USING ivfflat (embedding vector_cosine_ops) WITH (lists='100')
// Table: conversations
...
//   CREATE INDEX idx_document_signatures_tenant_id ON public.document_signatures USING btree (tenant_id)
// Table: email_campaigns
...
// Table: medical_record_sections
//   CREATE INDEX idx_medical_record_sections_record_id ON public.medical_record_sections USING btree (record_id)
...
//   CREATE INDEX idx_medical_reports_tenant_id ON public.medical_reports USING btree (tenant_id)
// Table: messages
...
// Table: notifications
//   CREATE INDEX idx_notifications_tenant ON public.notifications USING btree (tenant_id, created_at DESC)
...
//   CREATE UNIQUE INDEX unique_semantic_type_per_pipeline ON public.pipeline_stages USING btree (pipeline_id, semantic_type) WHERE (semantic_type IS NOT NULL)
// Table: pipelines
...
//   CREATE INDEX idx_specialty_templates_tenant_id ON public.specialty_templates USING btree (tenant_id)
// Table: tenant_api_keys
//   CREATE INDEX idx_tenant_api_keys_provider ON public.tenant_api_keys USING btree (tenant_id, provider)
...
//   CREATE UNIQUE INDEX tenant_email_settings_tenant_id_provider_key ON public.tenant_email_settings USING btree (tenant_id, provider)
// Table: tenant_email_usage
//   CREATE INDEX idx_tenant_email_usage_tenant_id ON public.tenant_email_usage USING btree (tenant_id)
...
// Table: tenant_whatsapp_usage
//   CREATE INDEX idx_tenant_whatsapp_usage_tenant_id ON public.tenant_whatsapp_usage USING btree (tenant_id)
...
//   CREATE INDEX idx_transcriptions_tenant_id ON public.transcriptions USING btree (tenant_id)
// Table: treatment_plans
...
//   CREATE INDEX idx_treatment_plans_tenant_id ON public.treatment_plans USING btree (tenant_id)
// Table: verification_codes
